...
Every Sunday the Weekly Upgrade routine writes one file here named `YYYY-WW.md` (year and ISO week number, e.g. `2026-40.md`).

Each digest has, in simple English:

1. **Needs Aakash**: HIGH-risk PRs waiting for approval and open decisions. Read this part first.
