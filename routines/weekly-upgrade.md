...
3. **Lessons**: read `knowledge/lessons.md` and the private `private-lessons.md`. When a lesson has been seen 2+ times, turn it into a rule, a skill checklist item, or a CI check (general wording only in the public repo).
...
6. **Digest**: write `digests/YYYY-WW.md` (ISO week) in simple English:
   ...
   - No private information. Put private details in `asen-engineering-private/audit-reports/digest-YYYY-WW-private.md`.
